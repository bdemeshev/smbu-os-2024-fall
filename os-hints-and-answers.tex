...
Если $\Delta b_1 = 2$, то старая точка $D = (4, 2)$ остаётся оптимальной, $\Delta z = y_1 \Delta b_1 = 4 \cdot 2 = 8$.
...
Если $\Delta b_2 = -2$, то новый оптимум

При $\Delta z = 8$ нужно взять $\Delta b_1 = 2$.

Значение $\Delta z = -8$ невозможно ни при каком $\Delta b_1$.
